 ...
 * @method string|void  prepare(string $query, mixed ...$args)
 ...
 * @method int|bool  insert(string $table, array $data, array|string|null $format = null)
 * @method int|bool  replace(string $table, array $data, array|string|null $format = null)
 * @method int|bool  update(string $table, array $data, array $where, array|string|null $format = null, array|string|null $where_format = null)
 ...
 * @method string|null  get_var(string|null $query, int $x = 0, int $y = 0)
